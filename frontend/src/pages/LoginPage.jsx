...
const LoginPage = () => {
  ...
  return (
    ...
    justfiy-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      {currState === "Sign up" && !isDataSubmitted && (
        <input type="text" className='p-2 border border-gray-500 
      ...
      {!isDataSubmitted && (
        ...
        focus:ring-2 focus:ring-indigo-500' type='email' 
